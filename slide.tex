...
\begin{document}
    ...
    \include{secciones/01-introduccion-corta}
    ...
    %\include{secciones/06-Familiarizacion}
    % Sección de Resultados
    \include{secciones/08-resultados/_index}

    \include{secciones/07-conclusion}
    ...
    \begin{frame}
        ...
        \endgroup
    \end{frame}
    \include{secciones/07-implementacion/_index}
    \include{anexos/A-comparativas.tex}
    \include{anexos/B-Diagramas.tex}
    \include{anexos/C-AG.tex}
    \include{anexos/D-Calendario}
    \include{anexos/E-Resultados.tex}
