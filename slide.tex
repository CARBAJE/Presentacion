...
\begin{document}
    ...
    \include{secciones/06-Familiarizacion.tex}
    \include{secciones/07-conclusion.tex}
    ...
    \begin{frame}
        ...
        \endgroup
    \end{frame}
    \input{anexos/A-comparativas.tex}
    \input{anexos/B-Diagramas.tex}
    \input{anexos/C-AG.tex}
